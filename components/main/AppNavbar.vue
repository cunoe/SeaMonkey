  ...
  <div>
    <div :class="{'flex text-center backdrop-blur': isSetBackground, 'flex text-center': !isSetBackground}"  :style="{backgroundColor: getBackgroundColor()}">
      <div class="container mx-auto columns-3">
        ...
        <!-- 右侧头像部分 -->
        <div>
          <nuxt-link to="https://github.com/cunoe/SeaMonkey/releases" target="_blank" class="btn btn-ghost text-xl text-gray-400 hover:text-white"><img src="/favicon.ico" alt="Avatar" class="w-10 h-10 rounded-full"></nuxt-link>
