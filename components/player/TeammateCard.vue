...
<!--          </div>-->
          <div class="w-[16rem]">
            <div class="grid grid-cols-3 text-sm text-white/90">
...
<!--        <div class="absolute inset-y-0 right-0 bg-[#7678ed] rounded-lg shadow-lg p-12 w-[22rem] hover-scale">-->
        <div class="absolute inset-y-0 right-0 bg-[#7678ed] rounded-lg shadow-lg p-12 w-[22rem] hover-scale" :style="{backgroundColor: getPRColorFromUtil(battleData.ship_profile.pr)}">
...
<!--            </div>-->
            <div class="w-[16rem]">
              <div class="grid grid-cols-3 text-sm text-white/90 text-start">
                <div class=" ">场次 {{battleData.ship_profile.blt}}</div>
